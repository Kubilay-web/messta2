// ============================================================
// Türkiye il → ilçe verisi (sahibinden tarzı kademeli konum seçimi).
// Kaynak: 81 il ve resmi ilçeleri. Form + arama il/ilçe cascade'i bundan beslenir.
// ============================================================
...
export const TR_CITY_NAMES = Object.keys(TR_PROVINCES).sort((a, b) => a.localeCompare(b, "tr"));

export function districtsOf(city?: string | null): string[] {
  if (!city) return [];
  return TR_PROVINCES[city] ?? [];
}
