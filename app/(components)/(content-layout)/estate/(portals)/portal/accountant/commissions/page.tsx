...
import CommissionsUI from "../../../../(back)/dashboard/finance/commissions/CommissionsUI";

export const metadata: Metadata = { title: "Komisyonlar - Muhasebe Portalı" };

export default async function AccountantCommissionsPage({
  searchParams,
}: {
