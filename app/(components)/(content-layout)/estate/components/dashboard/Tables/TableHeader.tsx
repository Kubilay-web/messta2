...
export default function TableHeader({
  ...
  return (
    <div className="mb-3 w-full min-w-0">
      <div className="flex items-center justify-between gap-2 border-b border-gray-200 dark:border-gray-600 py-3 min-w-0">
        <h2 className="scroll-m-20 text-lg sm:text-2xl font-semibold tracking-tight first:mt-0 truncate min-w-0">
          {title} ({data.length})
        </h2>
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          {showImport && (
            <Dialog>
              ...
              {loading ? (
                <DialogContent className="w-[95vw] max-w-[425px] bg-white text-black">
                  <DialogHeader>
