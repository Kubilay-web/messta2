...
export const metadata: Metadata = { title: "Yeni Bakım Talebi - EstatePro" };
    ...
    <div className="w-full max-w-3xl mx-auto p-4 sm:p-6">
      <Card className="border-t-4 border-blue-600 shadow">
        <CardContent className="p-4 sm:p-6">
          <MaintenanceForm properties={properties as any[]} agents={agents as any[]} clients={clients as any[]} agencyId={agencyId} />
        </CardContent>
      </Card>
    </div>
  );
